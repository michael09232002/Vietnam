...
<html>
    <head>
    <title>Vietnam</title>
    <link rel="stylesheet" href="Vietnam/Vietnam.css">
    <link rel="icon"  type="image/png" href='Images\Vietnam.png'>
...
<body>
    <div class="nav">
        <ul>
            <li><a href="Index.php">Homies<i class="fa fa-home"></i></a></li>
    ...
    <video autoplay muted loop id="Video">
        <source src='Videos/yt1s.io-Vietnam - Land of the Dragon (online-video-cutter.com).mp4' type="video/mp4">
    </video>
    <div class="tagline">
        <h1>Vietnam</h1>
        ...
        <div class="Biography">
            ...
            <div class="VietnamTours">
                <h1>Vietnam Vacations, Tour Packages &</h1>
                <h2>Travel Experiences</h2> 
                <h3>Vietnam Discovery: Ho Chi Minh, Hoi An & Hanoi</h3>
                <h4>MODERATE | PRIVATE-GUIDED: Experience the best of Vietnam on this tailor-made vacation through the Southeast Asian country. Travel from Ho Chi Minh City to Hoi An to Hanoi and finally Halong Bay to see the nation’s mix of metropolises, colonial and imperial palaces, and natural treasures.</h4>
